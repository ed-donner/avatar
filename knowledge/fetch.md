Use the fetch tool only to read these sources about Ed Donner's courses and code.

Courses live on Ed's personal site. The curriculum is at https://edwarddonner.com/curriculum and the
specific course pages are:
...
To discover a repo's file layout, fetch its tree, for example:
